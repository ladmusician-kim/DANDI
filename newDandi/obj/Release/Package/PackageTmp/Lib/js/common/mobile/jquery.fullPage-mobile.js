...
(function ($) {
    $.fn.fullpage = function (options) {
		...
		*/
        ...
        $(".dandi-btn-assign").click(function () {
            var next = $('.fp-section.active').next('.fp-section');
            scrollPage(next, null, false);
        });
        $(".dandi-btn-login").click(function () {
            var next = $('.fp-section.active').next('.fp-section').next('.fp-section');
            scrollPage(next, null, false);
        });
		...
		*/
        ...
        /* dj : footer 색상 바꾸기 */
        function checkSectionFooter(element) {
            if (element.attr('id') == 'section1') {
                $('.dandi-footer').show();
                $('.dandi-footer').css('background-color', '#36465d');
                $('.dandi-footer').text("이미 아이디가 있다면?!");
            } else if (element.attr('id') == 'section2') {
                $('.dandi-footer').show();
                $('.dandi-footer').css('background-color', '#43688b');
                $('.dandi-footer').text("아이디가 없다면?!");
            } else if (element.attr('id') == "section0") {
                $('.dandi-footer').hide();
            }
        }
